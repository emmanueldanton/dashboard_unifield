        ...
        html.Div([
            ...
            html.Div([
                ...
                dcc.Dropdown(id="cap-batt",
                             options=[{"label": v, "value": v}
                                      for v in ["Tous", "OK", "Faible", "Inconnue"]],
...
def render_dispositifs(data):
    ...
    modal = html.Div(
        id="modal-dispositif",
        children=[
            html.Div(id="modal-dispositif-bg", n_clicks=0, className="modal-backdrop"),
            html.Div(id="modal-dispositif-content", className="modal-box"),
        ],
    ...
    return html.Div([
        html.Div([
            ...
            html.Div([
                ...
                dcc.Dropdown(
                    id="filter-batterie",
                    options=[{"label": v, "value": v}
                             for v in ["Tous", "Critique", "Faible", "OK"]],
                    value="Tous",
                    clearable=False,
                    className="dd-filter",
                ),
            ...
            html.Div([
                html.Label("Projets", className="filter-label"),
                dcc.Dropdown(
                    id="filter-projet-multi",
                    options=proj_opts,
                    multi=True,
        ...
        dcc.Store(id="store-dispositif-rows", data=rows),
        modal,
